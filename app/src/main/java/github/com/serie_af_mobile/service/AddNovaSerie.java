package github.com.serie_af_mobile.service;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        sppechBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Diz Aí");
        ...
        salvarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (finalIsUpdate){
                    ...
                    if (nome.isEmpty()) {
                        Toast.makeText(context, "Serie vazia não autorizada!!!", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        firestore.collection("serie").add(serieMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                            ...
                            public void onComplete(@NonNull Task<DocumentReference> serie) {
                                if (serie.isSuccessful()) {
                                    Toast.makeText(context, "Serie Salva", Toast.LENGTH_SHORT).show();
                                } else {
